<%-- 
    Document   : afegirPas
    Created on : 13-abr-2019, 16:26:27
    Author     : mari
--%>
 ...
 <!-- Secció del Formulari -->  
        ...
        <section class="container">
            <form:form modelAttribute="novaPersona" class="form-horizontal">
                <fieldset>
                    <legend>Afegir Personal de Administració i Servei</legend>
                    ...
                    <div class="form-group">
                        <label class="col-label col-lg-2 col-lg-s " for="carrec">Carrec: </label>
                        <div class="col-lg-10">
                            <form:input id="carrec" path="carrec" type ="text" class="form:input-large"/>
                        </div>
                    </div>
